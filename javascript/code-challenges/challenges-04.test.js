...
const updateAnimal = (arr, callback) => {
  ...
  return newArr;
  //way2
  // const arrAfterUpdate = [];
  // for (let i = 0; i < arr.length; i++) {
  //   const updatedAnimal = callback(arr[i]);
  //   arrAfterUpdate.push(updatedAnimal);
  // }

  // return arrAfterUpdate;
};
...
const sortNumbers = (arr) => {
  // Solution code here...
  const newArr= arr.sort((a, b) => a - b);//(a, b) => a - b  is a comparison function//smallest to largest.
  return newArr;
};
...
const sortBackwards = (arr) => {
  // Solution code here...
  const newArr= arr.sort((a, b) => b - a);//(a, b) => b - a is a comparison function// largest to smallest.
  return newArr;
};
